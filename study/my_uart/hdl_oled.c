...
#include "hdl_oled.h"
#include "hdl_oled_font.h"
#include "hdl_oled_bmp.h"
...
{
	i2c_write_byte(0x00,1,IIC_Command);
}
/**********************************************
// IIC Write Data
**********************************************/
...
{
	i2c_write_byte(0x40,1,IIC_Data);
}
...
void OLED_Init(void)
{
	...
	i2c_master_init(0x78, (unsigned char)(CLOCK_SYS_CLOCK_HZ / (4 * 2000*1000)));
